...
const Setting = () => {
  ...
  return (
    <div className="flex justify-center items-center bg-white shadow-xl my-24 mx-6 rounded-xl h-3/4">
      <div className="m-auto p-10 mr-4">
        <ul className="list-unstyled">
          <li className="mb-2 flex flex-col items-center">
            <Image src={Profile} alt="User profile" height={250} width={300} />
      ...
      <div className="flex-grow pl-10 p-10">
        ...
        <div className="grid grid-cols-2 gap-8 place-content-evenly">
          ...
          <div className="mb-4">
            ...
            <p className="text-black bg-gray p-3 rounded-lg w-4/5">Dela Cruz</p>
          </div>
          <div className="mb-4">
